...
<#list table.columns as column>
	...
	<div class="form-group">
		...
		<#if column.isDateTimeColumn>
			<input name="${column.columnNameLower}" id="${column.columnNameLower}" value='<fmt:formatDate value="<@jspEl classNameLower+"."+column.columnNameLower/>" pattern="yyyy-MM-dd"/>' class="form-control"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d'})"   maxlength="0" />
		<#else>
